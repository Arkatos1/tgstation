...
SUBSYSTEM_DEF(materials)
	...
	var/list/rigid_stack_recipes = list(
		new /datum/stack_recipe("Chair", CATEGORY_FURNITURE, /obj/structure/chair/greyscale, one_per_turf = TRUE, on_floor = TRUE, applies_mats = TRUE),
		new /datum/stack_recipe("Toilet", CATEGORY_PLUMBING, /obj/structure/toilet/greyscale, one_per_turf = TRUE, on_floor = TRUE, applies_mats = TRUE),
		new /datum/stack_recipe("Sink Frame", CATEGORY_PLUMBING, /obj/structure/sinkframe, one_per_turf = TRUE, on_floor = TRUE, applies_mats = TRUE),
		new /datum/stack_recipe("Floor tile", CATEGORY_CONSTRUCTION, /obj/item/stack/tile/material, 1, 4, 20, applies_mats = TRUE),
	)
