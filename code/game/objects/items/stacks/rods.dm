GLOBAL_LIST_INIT(rod_recipes, list ( \
	new/datum/stack_recipe("grille", CATEGORY_CONSTRUCTION, /obj/structure/grille, 2, time = 10, one_per_turf = TRUE, on_floor = FALSE), \
	new/datum/stack_recipe("table frame", CATEGORY_FURNITURE, /obj/structure/table_frame, 2, time = 10, one_per_turf = TRUE, on_floor = TRUE), \
	new/datum/stack_recipe("scooter frame", CATEGORY_GENERAL, /obj/item/scooter_frame, 10, time = 25, one_per_turf = FALSE), \
	new/datum/stack_recipe("linen bin", CATEGORY_FURNITURE, /obj/structure/bedsheetbin/empty, 2, time = 5, one_per_turf = FALSE), \
	new/datum/stack_recipe("railing", CATEGORY_CONSTRUCTION, /obj/structure/railing, 3, time = 18, window_checks = TRUE), \
	))
